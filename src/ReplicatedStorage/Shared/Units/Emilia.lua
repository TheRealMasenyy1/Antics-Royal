...
local Emilia = {}
Emilia.__index = setmetatable(Emilia,UnitManager)
...
function Emilia.Setup(Unit, CustomUnitInfo) 
	local self = UnitManager.new(Unit,CustomUnitInfo)
	setmetatable(self,Emilia)
	...
	self.Type = "Ground"
	self.Ability = "IceDaggers"--"IceDaggers"
