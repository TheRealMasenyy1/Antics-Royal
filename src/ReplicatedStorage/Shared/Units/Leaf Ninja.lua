...
local LeafNinja = {}
LeafNinja.__index = setmetatable(LeafNinja,UnitManager)
...
function LeafNinja.Setup(Unit, CustomUnitInfo) 
	local self = UnitManager.new(Unit,CustomUnitInfo)
	setmetatable(self,LeafNinja)
...
function LeafNinja:Attack(Enemy)
