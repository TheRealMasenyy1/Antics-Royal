...
local Hinata = {}
Hinata.__index = setmetatable(Hinata,UnitManager)
...
function Hinata.Setup(Unit, CustomUnitInfo) 
	local self = UnitManager.new(Unit,CustomUnitInfo)
	setmetatable(self,Hinata)
	...
	self.Type = "Ground"
	self.Ability = "ChakraBarrage"--"IceDaggers"
