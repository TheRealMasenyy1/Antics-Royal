...
local Nami = {}
Nami.__index = setmetatable(Nami,UnitManager)
...
function Nami.Setup(Unit, CustomUnitInfo) 
	local self = UnitManager.new(Unit,CustomUnitInfo)
	setmetatable(self,Nami)
	...
	self.Type = "Ground"
	self.Ability = "Thunderbolt Strike"--"IceDaggers"
