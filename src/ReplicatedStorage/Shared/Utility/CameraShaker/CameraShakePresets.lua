...
local CameraShakePresets = {
	...
	--- Summoning
	Summon = function()
		local c = CameraShakeInstance.new(1, 30, .3, .4)
	...
	SmallExplosion = function()
		local c = CameraShakeInstance.new(2.5, 5, 0, 1.5)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(4, 1, 1)
		return c
	end;
	...
	-- Sustained.
	Earthquake = function()
		local c = CameraShakeInstance.new(1, 3.5, 2, 10)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(1, 1, 0)
		return c
	end;
